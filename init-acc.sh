...
ethermintd add-genesis-account "$(ethermintd keys show $KEY -a --keyring-backend test)" 1000000000000000000000aphoton,1000000000000000000stake --keyring-backend test

# Sign genesis transaction
#ethermintd gentx $KEY 1000000000000000000000aphoton --keyring-backend test --chain-id $CHAINID

ethermintd gentx $KEY 1000000000000000000stake --amount=1000000000000000000000aphoton --chain-id $CHAINID --keyring-backend test
...
#ethermintd start --pruning=nothing --rpc.unsafe --trace --log_level "info"
