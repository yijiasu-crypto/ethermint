...
echo "Adding MNEMONIC"
echo $MNEMONIC | ethermintcli keys add $KEY --algo "eth_secp256k1" --recover
...
sleep 5
ethermintcli rest-server --laddr "tcp://localhost:8545" --unlock-key mykey --chain-id $CHAINID --trace --wsport 8546 --rpc-api="web3,eth,net,personal"
